...
export const blocks: Registry["items"] = [
  ...
  },
  {
    ...
    files: [
      {
        path: "blocks/job-status-card-01/page.tsx",
        type: "registry:page",
  ...
  },
  {
    ...
    files: [
      {
        path: "blocks/goal-progress-card-01/page.tsx",
        type: "registry:page",
  ...
  },
  {
    ...
    files: [
      {
        path: "blocks/onboarding-progress-card-01/page.tsx",
        type: "registry:page",
    ...
    meta: {
      ...
      mobile: "component",
      details:
        "Onboarding progress card with segmented meter visualization showing completion status. Features gradient-filled progress bars, checklist items with icons, and elegant centered layout. Built with shadcn/ui Card components with full dark mode support. Perfect for onboarding flows, setup wizards, multi-step processes, and user activation dashboards requiring visual progress tracking.",
    },
    categories: ["cruds"],
  },
  {
    ...
    files: [
      {
        path: "blocks/neon-calendar-01/page.tsx",
        type: "registry:page",
    ...
    meta: {
      ...
      mobile: "component",
      details:
        "Modern neon-styled calendar component with month navigation, date selection, event indicators, and selected date details panel. Features glowing accent colors, smooth hover states, event dots on specific dates, and today indicator ring. Built with shadcn/ui Card and Button components with custom neon CSS variables for consistent theming. Perfect for scheduling apps, event planners, booking systems, and any application requiring an elegant date selection interface with visual event markers.",
    },
    categories: ["cruds"],
  },
]
